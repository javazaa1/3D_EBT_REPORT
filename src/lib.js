...
export const ANCHOR_TYPES = new Set(['world', 'canvas', 'doc', 'screen', 'el']);
...
export function cleanAnchor(a) {
  ...
  if (a.type === 'el') {
    return typeof a.sel === 'string' && a.sel.length <= 600 && num(a.x) && num(a.y) && num(a.fx) && num(a.fy)
      ? { type: 'el', sel: a.sel, x: a.x, y: a.y, fx: a.fx, fy: a.fy } : null;
  }
